...
modified_model().fit_generator(datagen.flow(X_train, y_train, batch_size= 45),
                              epochs=10, validation_data=(X_test, y_test), callbacks=callbacks_list,
                              verbose=1, steps_per_epoch=X_train.shape[0] // 45)

from tensorflow.keras.models import load_model

# run the test harness for evaluating a model
def run_test_harness():
	model = load_model('/content/drive/MyDrive/Colab Notebooks/DATA/Final Examination_DANSECO/Model/weights-improvement-06-0.99.hdf5')
...
# Load saved model
saved_model = load_model("/content/drive/MyDrive/Colab Notebooks/DATA/Final Examination_DANSECO/Model/weights-improvement-06-0.99.hdf5")

# Load sample image
image = cv2.imread("/content/drive/MyDrive/Colab Notebooks/DATA/Final Examination_DANSECO/Soda/cocacola/134.jpg")
...
image1 = cv2.imread("/content/drive/MyDrive/Colab Notebooks/DATA/Final Examination_DANSECO/Soda/pepsi/128.jpg")
